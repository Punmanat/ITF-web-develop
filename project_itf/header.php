			...
			<section>
				...
				<section class="navbar navbar-default">
					<ul class="nav navbar-nav">
						<li id='fontit' style="font-size: 16px"><a href="index.php">Home</a></li>
						<li id='fontit' style="font-size: 16px"><a href="about.php">About Us</a></li>
						...
						<li class="dropdown" id='fontit' style="font-size: 16px"><a class="dropdown-toggle" data-toggle='dropdown' href="#">Product <span class='caret'></span></a>
							<ul class="dropdown-menu">
								...
								<li id='fontit' style="font-size: 16px"><a href="bathroom.php">Bedroom</a></li>
