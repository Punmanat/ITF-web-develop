...
<div id='myslider' class="carousel slide" data-ride='carousel'>
    ...
    <div class="carousel-inner">
        <div class="item active">
            <img src="img/living1.png">
            <!-- living room -->
        </div>
        <div class="item">
            <img src="img/living2.png">
            <!-- living room -->
        </div>
        <div class="item">
            <img src="img/bed1.png">
            <!-- bedroom -->
        </div>
        <div class="item">
            <img src="img/bed2.png">
            <!-- bedroom -->
        </div>
        <div class="item">
        ...
        <div class="item">
            <img src="img/kitchen2.png">
            <!-- kitchen -->
        </div>
        <div class="item">
            <img src="img/bathroom1.png">
            <!-- bathroom -->
        </div>
        <div class="item">
            <img src="img/bathroom2.png">
            <!-- bathroom -->
        </div>
